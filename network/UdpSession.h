...
namespace network
{
    ...
    {
    public:
        using OnSelectedPeerFn = std::function<void(std::shared_ptr<UdpSession>, const network::SocketAddr &)>;
    ...
    public:
        ...
        inline WorkType ToWorkJobType(UdpMuxHandler::UdpProto proto)
        {
            switch (proto)
            {
            case UdpMuxHandler::UdpProto::Stun:
                return WorkType::Stun;
            case UdpMuxHandler::UdpProto::Dtls:
                return WorkType::Dtls;
            case UdpMuxHandler::UdpProto::Rtp:
                return WorkType::Rtp;
            case UdpMuxHandler::UdpProto::Rtcp:
                return WorkType::Rtcp;
            default:
                return WorkType::Invalid;
            }
        }
